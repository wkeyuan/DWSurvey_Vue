              ...
              <el-form ref="form" :label-position="labelPosition" :model="form" >
                <el-row>
                  ...
                  <el-col :span="12">
                    ...
                    <div style="padding-left: 10px;">
                      <el-form-item>
                        <el-checkbox v-model="survey.surveyAttrs.anEndNumAttr.enabled">收集到
                          <el-input-number :min="1" :max="100000" v-model="survey.surveyAttrs.anEndNumAttr.endNum" label="份数" controls-position="right"></el-input-number>
                          份时结束</el-checkbox>
                      </el-form-item>
                      <el-form-item>
                        <el-checkbox v-model="survey.surveyAttrs.anEndTimeAttr.enabled">时间到
                          <el-date-picker
                            v-model="survey.surveyAttrs.anEndTimeAttr.endTime"
...
import {getDefaultSurveyStyle} from "../../../components/dw-survey-comp/dw-utils/dw-common/dw-common-utils";
import {initAnswerBySurvey, showPageByIndex} from "../../../components/dw-survey-comp/dw-utils/dw-survey-answer-data";
import {
  dwSurveyAnswerLogicLoad
} from "../../../components/dw-survey-comp/dw-answer-comp/dw-utils/dw-survey-answer-logic";
import {
  initAnswerSurveyProgress
} from "../../../components/dw-survey-comp/dw-answer-comp/dw-utils/dw-survey-answer-progress";
