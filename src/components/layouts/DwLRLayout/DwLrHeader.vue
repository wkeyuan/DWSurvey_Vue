                ...
                <div class="header-content-left">
                  <div class="logo">
                    <router-link :to="`${prevPath}/dw/survey`" >
                      ...
                      <h1>调问网</h1>
                      <span style="color: #ffa71d;font-size: 14px;position: absolute;margin-left: 10px;">社区版</span>
                    </router-link>
                  </div>
                  <!--                  <div><dw-lr-nav-menu></dw-lr-nav-menu></div>-->
                </div>
              </el-col>
              <el-col :span="6" style="text-align: right;padding-right: 10px;" >
                <div class="dw-display-flex-right" style="gap: 20px;">
                  ...
                  <el-dropdown @command="handleCommand">
                    <span class="el-dropdown-link" >
                      <i class="gitbtn fa-brands fa-square-git" style=""></i>
                    </span>
                    <el-dropdown-menu slot="dropdown">
                      <el-dropdown-item command="Github"><i class="fa-brands fa-github"></i> GitHub</el-dropdown-item>
                      <el-dropdown-item command="Gitee">
                        <div style="display: flex;align-items: center;padding: 2px 0px;gap: 5px;">
                          <img src="@/assets/image/resource/dw-info/gitee.svg" width="16"/>
                          <div>Gitee</div>
                        </div>
                      </el-dropdown-item>
                      <el-dropdown-item command="DWSurvey">
                        <div style="display: flex;align-items: center;padding: 2px 0;gap: 5px;">
...
import DwNavMenu from '../DwNavMenu'
import DwLrNavMenu from './DwLrNavMenu.vue'
...
.dw-header-main .header-content-left{
  display: flex;
  line-height: 60px;
}
.dw-header-main .header-content-left .logo{
  width: 210px;
  /*text-align: center;*/
  padding-left: 10px;
}
.dw-header-main .header-content-left .logo img{
  vertical-align: middle;
}
.dw-header-main .header-content-left .logo h1{
...
.gitbtn:hover{
  background: var(--dw-primary-bg-color-active);
}
</style>
