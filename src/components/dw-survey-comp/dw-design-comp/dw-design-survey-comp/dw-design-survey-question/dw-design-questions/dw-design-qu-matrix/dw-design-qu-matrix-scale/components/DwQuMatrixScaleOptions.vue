<template>
  <div>
    <dw-qu-matrix-option-common2 v-model="survey.questions[index].quRows" :survey="survey" :index="index" :qu-type="survey.questions[index].quType"></dw-qu-matrix-option-common2>
  </div>
</template>
