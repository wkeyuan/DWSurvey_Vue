  ...
  <el-row type="flex" justify="space-between" align="middle" >
    <el-col :span="16">
      <div class="header-content-left">
        <div class="logo">
          <a href="/#/v6/dw/survey" style="text-decoration: none;">
            ...
            <template v-if="survey.surveyType===undefined || survey.surveyType===null">
              <h1>调问网-全新问卷编辑器</h1>
            </template>
            <span v-show="isDemo" style="font-size: 13px;color: #c7c7c7;">纯VUE全部重写，易于二开上手</span>
          </a>
        </div>
      </div>
    </el-col>
...
export default {
  ...
  computed: {
    isDemo () {
      return dwFooterLocalStorage.isDemo()
    }
  },
  methods: {
