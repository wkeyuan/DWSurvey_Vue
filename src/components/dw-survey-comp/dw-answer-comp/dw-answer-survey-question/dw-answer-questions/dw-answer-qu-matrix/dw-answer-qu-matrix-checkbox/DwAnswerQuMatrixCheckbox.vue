<template>
  <dw-answer-qu-matrix-option-common1 v-model="survey" :index="index" :qu-type="survey.questions[index].quType"></dw-answer-qu-matrix-option-common1>
</template>
